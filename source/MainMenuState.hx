...
class MainMenuState extends MusicBeatState
{
	...
	#if !switch
	var optionShit:Array<String> = ['story mode', 'freeplay', "betadciu", 'credits','options']; //Original ['story mode', 'freeplay', 'donate', 'options'];
	#else
	...
	public static var kadeEngineVer:String = "1.0.0" + nightly; //original 1.5.4
	...
	override function create()
	{
		...
		/*var datos = cast haxe.Json.parse( lime.utils.Assets.getText( Paths.json('offsets') ).trim() );
		var ses:Array<Dynamic> = datos.posicion;
		char = new Boyfriend(ses[0],ses[1],ses[2]);
		char.scale.set(ses[3],ses[3]);
		char.updateHitbox();*/
		char.playAnim("idle");
