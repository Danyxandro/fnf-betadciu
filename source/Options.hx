...
class CachingOption extends Option
{
	...
	private override function updateDisplay():String
		return "Caching " + (FlxG.save.data.caching ? "on" : "off");
}

class OldVoiceOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.oldVoice = !FlxG.save.data.oldVoice;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Old Beat Voice: " + (!FlxG.save.data.oldVoice ? "off" : "on");
	}
}

class SingCamOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	private override function updateDisplay():String
	{
		return "Move cam while singing: " + (!FlxG.save.data.singCam ? "off" : "on");
	}
}
...
class SavePlays extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.savePlay = !FlxG.save.data.savePlay;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return (FlxG.save.data.savePlay ? "Save replays" : "Don't save replays");
	}
}

class AllowCharChange extends Option
{
	public function new(desc:String)
	{
		super();
	...
	private override function updateDisplay():String
	{
		return (FlxG.save.data.enableCharchange ? "Changing chars enabled" : "Changing chars disabled");
	}
}