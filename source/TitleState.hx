...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		gfDance = new FlxSprite((FlxG.width * 0.4) + 70, (FlxG.height * 0.07) - 80);
		//gfDance = new FlxSprite(150,-100);
		gfDance.frames = Paths.getSparrowAtlas('gfDanceTitle');
		//gfDance.animation.addByIndices('danceLeft', 'gfDance', CoolUtil.numberArray(16), "", 24, false);
		//gfDance.animation.addByIndices('danceRight', 'gfDance', CoolUtil.numberArray(16), "", 24, false);
